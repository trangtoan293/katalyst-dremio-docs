...
## Dimensions of Performance Optimization[​](/help-support/well-architected-framework/performance/#dimensions-of-performance-optimization "Direct link to Dimensions of Performance Optimization")
...
## Principles[​](/help-support/well-architected-framework/performance/#principles "Direct link to Principles")
### Perform Regular Maintenance[​](/help-support/well-architected-framework/performance/#perform-regular-maintenance "Direct link to Perform Regular Maintenance")
...
### Scale-out Coordinators[​](/help-support/well-architected-framework/performance/#scale-out-coordinators "Direct link to Scale-out Coordinators")
...
### Optimize for Efficiency[​](/help-support/well-architected-framework/performance/#optimize-for-efficiency "Direct link to Optimize for Efficiency")
...
### Optimize Engines[​](/help-support/well-architected-framework/performance/#optimize-engines "Direct link to Optimize Engines")
...
## Best Practices[​](/help-support/well-architected-framework/performance/#best-practices "Direct link to Best Practices")
### Clean the KV Store[​](/help-support/well-architected-framework/performance/#clean-the-kv-store "Direct link to Clean the KV Store")
...
The [clean operation](/reference/admin-cli/metadata-cleanup) ensures any orphaned metadata entries (excluding files with metadata stored in distributed storage, such as Parquet, ORC read-only, and AVRO files), orphaned profiles, old jobs, old profiles, and temporary dataset versions are deleted. You can also use the `clean` command to reindex and compact the data to reduce fragmentation on disk.
...
### Right-size Scale-out Coordinators[​](/help-support/well-architected-framework/performance/#right-size-scale-out-coordinators "Direct link to Right-size Scale-out Coordinators")
[Secondary coordinator nodes](/deploy-dremio/other-options/standalone/dremio-config#configuring-basic-services) can be used to improve query planning concurrency and distribute query planning specifically for ODBC and JDBC client requests. Secondary coordinator nodes do not plan queries that arrive via Dremio’s SQL REST API.
...
### Design Semantic Layer for Workload Performance[​](/help-support/well-architected-framework/performance/#design-semantic-layer-for-workload-performance "Direct link to Design Semantic Layer for Workload Performance")
...
### Improve Query Performance[​](/help-support/well-architected-framework/performance/#improve-query-performance "Direct link to Improve Query Performance")
...
The query history also allows you to see the lengths of time spent planning queries. Queries with long planning times should be investigated. Long planning times can be caused by:
  ...
  * a high number of Reflections being considered, which could mean there are too many Reflections defined in the environment (see [Remove unused Reflections](/help-support/well-architected-framework/cost/#remove-unused-reflections) to learn how to identify if there are redundant Reflections in your cluster)
...
### Review Dremio Profiles to Pinpoint Bottlenecks[​](/help-support/well-architected-framework/performance/#review-dremio-profiles-to-pinpoint-bottlenecks "Direct link to Review Dremio Profiles to Pinpoint Bottlenecks")
...
### Rebalance Workload Management Rules[​](/help-support/well-architected-framework/performance/#rebalance-workload-management-rules "Direct link to Rebalance Workload Management Rules")
...
### Right-size Engines and Executors[​](/help-support/well-architected-framework/performance/#right-size-engines-and-executors "Direct link to Right-size Engines and Executors")
...
### Leverage Reflections to Improve Performance[​](/help-support/well-architected-framework/performance/#leverage-reflections-to-improve-performance "Direct link to Leverage Reflections to Improve Performance")
...
### Use Supporting Anchors[​](/help-support/well-architected-framework/performance/#use-supporting-anchors "Direct link to Use Supporting Anchors")
...
### Horizontally Partition Reflections that Have Many Rows[​](/help-support/well-architected-framework/performance/#horizontally-partition-reflections-that-have-many-rows "Direct link to Horizontally Partition Reflections that Have Many Rows")
...
### Partition Reflections to Allow for Partition-Based Incremental Refreshes[​](/help-support/well-architected-framework/performance/#partition-reflections-to-allow-for-partition-based-incremental-refreshes "Direct link to Partition Reflections to Allow for Partition-Based Incremental Refreshes")
Incremental refreshes of data in Reflections are much faster than full refreshes. Partition-based incremental refreshes are based on Iceberg metadata that is used to identify modified partitions and to restrict the scope of the refresh to only those partitions. For more information about partition-based incremental refreshes, see Types of Refresh for Reflections on Apache Iceberg Tables, Filesystem Sources, Glue Sources, and Hive Sources in [Refreshing Reflections](/acceleration/manual-reflections/refreshing-reflections#types-of-refresh-for-reflections-on-apache-iceberg-tables-and-on-certain-types-of-datasets-in-filesystem-sources-aws-glue-sources-and-hive-sources).
...
### Sort Reflections on High-Cardinality Fields[​](/help-support/well-architected-framework/performance/#sort-reflections-on-high-cardinality-fields "Direct link to Sort Reflections on High-Cardinality Fields")
...
### Create Reflections from Joins that are Based on Joins from Multiple Queries[​](/help-support/well-architected-framework/performance/#create-reflections-from-joins-that-are-based-on-joins-from-multiple-queries "Direct link to Create Reflections from Joins that are Based on Joins from Multiple Queries")
...
### Establish a Routine for Checking Reflections[​](/help-support/well-architected-framework/performance/#establish-a-routine-for-checking-reflections "Direct link to Establish a Routine for Checking Reflections")
...
### Optimize Metadata Refresh performance[​](/help-support/well-architected-framework/performance/#optimize-metadata-refresh-performance "Direct link to Optimize Metadata Refresh performance")
...
## Assign Ownership to Roles Instead of Individual Users[​](/help-support/well-architected-framework/performance/#assign-ownership-to-roles-instead-of-individual-users "Direct link to Assign Ownership to Roles Instead of Individual Users")
...
[Previous Security](/help-support/well-architected-framework/security)[Next Cost Optimization](/help-support/well-architected-framework/cost)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fhelp-support%2Fwell-architected-framework%2Fperformance%2F&_biz_t=1777950382078&_biz_i=Performance%20Efficiency%20%7C%20Dremio%20Documentation&_biz_n=138&rnd=500077&cdn_o=a&_biz_z=1777950382078)
