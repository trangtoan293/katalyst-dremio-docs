...
On this page
# Dremio Preferences
Preferences let you customize the behavior of specific features in the [Dremio console](/get-started/quick_tour).
## Managing Preferences[​](/help-support/advanced-topics/dremio-preferences/#managing-preferences "Direct link to Managing Preferences")
To view the available preferences in the Dremio console:
  1. Click the Settings ![](https://docs.dremio.com/images/icons/project-settings.png) icon in the side navigation bar.
...
| SQL Autocomplete  | Enabled  | Autocomplete provides suggestions for SQL keywords, catalog objects, and functions while you are constructing SQL statements. ![](https://docs.dremio.com/images/autocomplete-button.png) is visible in the SQL editor, although users can switch the button off within their own accounts.  | The button is hidden from the SQL editor and suggestions are not provided.  | See how this works in the [SQL editor](/get-started/quick_tour/#5-sql-editor).  |  
| Copy or Download Results  | Enabled  |  ![](https://docs.dremio.com/images/copy-button.png) and ![](https://docs.dremio.com/images/download-button.png) are visible above the results table, because users are allowed to copy or download the results in the SQL editor.  | The buttons are hidden and users cannot copy or download results in the SQL editor.  | See how this works in [result set actions](/get-started/quick_tour/#6-result-set-actions).  |  
| Rerun Query on Download  | Disabled  | When you download results, the query will be re-run and the results will be written out to the download file. Up to 1 million rows can be downloaded with this option enabled.  | When you download results, the results from the last run of the query will be written out to the download file.  | See how this works in [result set actions](/get-started/quick_tour/#6-result-set-actions).  |  
| Query Dataset on Click  | Enabled  | Clicking on a dataset opens the SQL Runner with a default `SELECT` statement on the dataset.  | Clicking on a dataset opens the Datasets page, showing a `SELECT` statement on the dataset or the dataset's definition that you can view or edit depending on your dataset privileges.  | See how this works in [Querying a Dataset on Click](/get-started/quick_tour/#datasets-page).  |  
...
[Previous Creating and Querying Wide Tables](/help-support/advanced-topics/wide-tables)[Next Gandiva-based Execution](/help-support/advanced-topics/gandiva)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fhelp-support%2Fadvanced-topics%2Fdremio-preferences%2F&_biz_t=1777950379589&_biz_i=Dremio%20Preferences%20%7C%20Dremio%20Documentation&_biz_n=129&rnd=644313&cdn_o=a&_biz_z=1777950379589)
