...
slug: /help-support/well-architected-framework/operations/capacity-planning
...
## Principles[​](/help-support/well-architected-framework/operations/capacity-planning/)
...
## Separate Workloads[​](/help-support/well-architected-framework/operations/capacity-planning/)
...
## Scale Engines[​](/help-support/well-architected-framework/operations/capacity-planning/)
...
Scaling outside of these mechanisms, such as by adding arbitrary executor nodes or resizing outside of prescribed sizes, is not supported. For supported engine sizes, see [Sizes](/deploy-dremio/managing-engines-kubernetes).
For recommended configurations, see Server or Instance Hardware.
## Plan Capacity[​](/help-support/well-architected-framework/operations/capacity-planning/)
...
## Monitor Scaling Triggers[​](/help-support/well-architected-framework/operations/capacity-planning/)
...
### Query Execution Errors[​](/help-support/well-architected-framework/operations/capacity-planning/)
...
### Query Stage Performance SLAs[​](/help-support/well-architected-framework/operations/capacity-planning/)
