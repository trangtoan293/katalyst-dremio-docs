...
## Principles[​](/help-support/well-architected-framework/semantic/#principles "Direct link to Principles")
## Manage Your Data Catalog[​](/help-support/well-architected-framework/semantic/#manage-your-data-catalog "Direct link to Manage Your Data Catalog")
...
To help manage this data catalog, the [data panel](/get-started/quick_tour/#datasets-page) shows the hierarchy of data objects and how they relate to each other. Use this data panel to create, modify, or remove data objects in your catalog. The data catalog is also used when setting the context of data objects in the [SQL editor](/get-started/quick_tour/#5-sql-editor), ensuring that the query is referencing a specific data object from a source, space, or folder.
## Organize Environments and Spaces[​](/help-support/well-architected-framework/semantic/#organize-environments-and-spaces "Direct link to Organize Environments and Spaces")
...
Within each environment, use your data panel to create spaces. [Spaces](/what-is-dremio/key-concepts#spaces-and-folders) let you group datasets by common themes such as a project, purpose, department, or geographic region. See example below:
...
### Layer Views[​](/help-support/well-architected-framework/semantic/#layer-views "Direct link to Layer Views")
...
### Annotate Datasets to Enhance Discovery and Understanding[​](/help-support/well-architected-framework/semantic/#annotate-datasets-to-enhance-discovery-and-understanding "Direct link to Annotate Datasets to Enhance Discovery and Understanding")
...
## Best Practices[​](/help-support/well-architected-framework/semantic/#best-practices "Direct link to Best Practices")
### Use the Preparation Layer for 1:1 Mapping to Tables[​](/help-support/well-architected-framework/semantic/#use-the-preparation-layer-for-11-mapping-to-tables "Direct link to Use the Preparation Layer for 1:1 Mapping to Tables")
...
### Use the Business Layer to Logically Join Datasets[​](/help-support/well-architected-framework/semantic/#use-the-business-layer-to-logically-join-datasets "Direct link to Use the Business Layer to Logically Join Datasets")
...
### Use the Application Layer to Arrange Datasets for Consumption[​](/help-support/well-architected-framework/semantic/#use-the-application-layer-to-arrange-datasets-for-consumption "Direct link to Use the Application Layer to Arrange Datasets for Consumption")
...
## Use Role-Based Access Control[​](/help-support/well-architected-framework/semantic/#use-role-based-access-control "Direct link to Use Role-Based Access Control")
...
### Development Environments[​](/help-support/well-architected-framework/semantic/#development-environments "Direct link to Development Environments")
...
### QA/Test and Production Environments[​](/help-support/well-architected-framework/semantic/#qatest-and-production-environments "Direct link to QA/Test and Production Environments")
...
## Build Upon Views[​](/help-support/well-architected-framework/semantic/#build-upon-views "Direct link to Build Upon Views")
...
### User Experience[​](/help-support/well-architected-framework/semantic/#user-experience "Direct link to User Experience")
...
* None
 |  
## Use Case Examples[​](/help-support/well-architected-framework/semantic/#use-case-examples "Direct link to Use Case Examples")
### Example 1[​](/help-support/well-architected-framework/semantic/#example-1 "Direct link to Example 1")
...
### Example 2[​](/help-support/well-architected-framework/semantic/#example-2 "Direct link to Example 2")
...
### Leverage Tags to Enhance Searchability[​](/help-support/well-architected-framework/semantic/#leverage-tags-to-enhance-searchability "Direct link to Leverage Tags to Enhance Searchability")
...
### Create Wiki Content to Embellish Datasets[​](/help-support/well-architected-framework/semantic/#create-wiki-content-to-embellish-datasets "Direct link to Create Wiki Content to Embellish Datasets")
...
### Use Data Lineage to Understand Relationships Between Objects[​](/help-support/well-architected-framework/semantic/#use-data-lineage-to-understand-relationships-between-objects "Direct link to Use Data Lineage to Understand Relationships Between Objects")
...
[Previous Operational Excellence](/help-support/well-architected-framework/operations)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fhelp-support%2Fwell-architected-framework%2Fsemantic%2F&_biz_t=1777950381817&_biz_i=Self-Service%20Semantic%20Layer%20%7C%20Dremio%20Documentation&_biz_n=136&rnd=425721&cdn_o=a&_biz_z=1777950381818)
