...
## Notice About Dremio 16.0+ Upgrades[​](/release-notes/unsupported-releases/version-1800-release-notes#notice-about-dremio-160-upgrades "Direct link to Notice About Dremio 16.0+ Upgrades")
...
## 18.4.0 (June 2022) Enterprise[​](/release-notes/unsupported-releases/version-1800-release-notes#1840-june-2022-enterprise "Direct link to 1840-june-2022-enterprise")
### Issues Fixed[​](/release-notes/unsupported-releases/version-1800-release-notes#issues-fixed "Direct link to Issues Fixed")
DX-41028 
...
## 18.3.0 (November 2021) Enterprise[​](/release-notes/unsupported-releases/version-1800-release-notes#1830-november-2021-enterprise "Direct link to 1830-november-2021-enterprise")
### Issues Fixed[​](/release-notes/unsupported-releases/version-1800-release-notes#issues-fixed-1 "Direct link to Issues Fixed")
DX-39288 
  * Fixed a race condition that was causing a coordinator restart on some external zookeeper failures.


## 18.2.0 (October 2021)[​](/release-notes/unsupported-releases/version-1800-release-notes#1820-october-2021 "Direct link to 18.2.0 \(October 2021\)")
### Issues Fixed[​](/release-notes/unsupported-releases/version-1800-release-notes#issues-fixed-2 "Direct link to Issues Fixed")
DX-37696 
DX-37554 
...
### Known Issues[​](/release-notes/unsupported-releases/version-1800-release-notes#known-issues "Direct link to Known Issues")
DX-38101 
When impersonation is enabled, only administrators may assign privileges in Dremio.
## 18.1.0 (September 2021)[​](/release-notes/unsupported-releases/version-1800-release-notes#1810-september-2021 "Direct link to 18.1.0 \(September 2021\)")
### What's New[​](/release-notes/unsupported-releases/version-1800-release-notes#whats-new "Direct link to What's New")
Two new options have been added to the [`AccelerationRefreshPolicy` parameter](/reference/api/catalog/table#accelerationrefreshpolicy) of the Catalog v3 APIs for datasets: `accelerationNeverExpire` and `accelerationNeverRefresh`.
### Issues Fixed[​](/release-notes/unsupported-releases/version-1800-release-notes#issues-fixed-3 "Direct link to Issues Fixed")
DX-37122 
...
## 18.0.0 (August 2021)[​](/release-notes/unsupported-releases/version-1800-release-notes#1800-august-2021 "Direct link to 18.0.0 \(August 2021\)")
#### Upgrading to 18.0[​](/release-notes/unsupported-releases/version-1800-release-notes#upgrading-to-180 "Direct link to Upgrading to 18.0")
...
### What's New[​](/release-notes/unsupported-releases/version-1800-release-notes#whats-new-1 "Direct link to What's New")
#### Local Users & Roles[​](/release-notes/unsupported-releases/version-1800-release-notes#local-users--roles "Direct link to Local Users & Roles")
...
#### New Job History & Job Details Screens[​](/release-notes/unsupported-releases/version-1800-release-notes#new-job-history--job-details-screens "Direct link to New Job History & Job Details Screens")
...
#### Query Visualizer[​](/release-notes/unsupported-releases/version-1800-release-notes#query-visualizer "Direct link to Query Visualizer")
...
#### Reflection Refresh Job Routing (Preview)[​](/release-notes/unsupported-releases/version-1800-release-notes#reflection-refresh-job-routing-preview "Direct link to Reflection Refresh Job Routing \(Preview\)")
...
#### Elasticsearch 7 Connector[​](/release-notes/unsupported-releases/version-1800-release-notes#elasticsearch-7-connector "Direct link to Elasticsearch 7 Connector")
DX-32610 
...
#### Improved Metadata Refresh[​](/release-notes/unsupported-releases/version-1800-release-notes#improved-metadata-refresh "Direct link to Improved Metadata Refresh")
DX-XXXXX 
...
For more information on how to enable this functionality, see [Improved Metadata Refreshes](/admin/metadata-caching/#improved-metadata-refreshes-preview). In a future version of Dremio, this will be automatically enabled by default.
This functionality will be enabled by default in a future release of Dremio.
#### Unlimited Splits for Hive & FileSystem Sources[​](/release-notes/unsupported-releases/version-1800-release-notes#unlimited-splits-for-hive--filesystem-sources "Direct link to Unlimited Splits for Hive & FileSystem Sources")
...
For more information on how to enable this functionality, see [Unlimited Splits](/admin/metadata-caching/#unlimited-splits).
This functionality is enabled by default for organizations using Dremio v21.0+.
### Issues Fixed[​](/release-notes/unsupported-releases/version-1800-release-notes#issues-fixed-4 "Direct link to Issues Fixed")
...
### Breaking Changes[​](/release-notes/unsupported-releases/version-1800-release-notes#breaking-changes "Direct link to Breaking Changes")
#### Mixed Type Removal[​](/release-notes/unsupported-releases/version-1800-release-notes#mixed-type-removal "Direct link to Mixed Type Removal")
Dremio has removed support for columns with mixed data types for FileSystem sources. A standard schema is now enforced. Columns with compatible mixed data types will be promoted to a single data type. However, columns with incompatible mixed data types will be unreadable by Dremio until such instances are resolved. Visit [this page](/query-manage/managing-data/data-curation/#mixed-data-types-in-filesystem-sources) for additional information.
...
#### User/Role v2 APIs[​](/release-notes/unsupported-releases/version-1800-release-notes#userrole-v2-apis "Direct link to User/Role v2 APIs")
DX-35643 
...
### Known Issues[​](/release-notes/unsupported-releases/version-1800-release-notes#known-issues-1 "Direct link to Known Issues")
...
[Previous 19.x Release Notes](/release-notes/unsupported-releases/version-1900-release-notes)[Next 17.x Release Notes](/release-notes/unsupported-releases/version-1700-release-notes)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Frelease-notes%2Funsupported-releases%2Fversion-1800-release-notes%2F&_biz_t=1777950700600&_biz_i=18.x%20Release%20Notes%20%7C%20Dremio%20Documentation&_biz_n=741&rnd=451391&cdn_o=a&_biz_z=1777950700601)
