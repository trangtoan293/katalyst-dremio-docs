...
## Supported Operating Systems[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#supported-operating-systems "Direct link to Supported Operating Systems")
...
## Authentication Methods[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#authentication-methods "Direct link to Authentication Methods")
Dremio supports several authentication methods for client connections.
### Username and Password[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#username-and-password "Direct link to Username and Password")
Pass a username and password with the **UID** and **PWD** properties.
### Personal Access Tokens Enterprise[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#personal-access-tokens-enterprise "Direct link to personal-access-tokens-enterprise")
...
Dremio recommends [OAuth access tokens](/client-applications/drivers/arrow-flight-sql-odbc-driver#oauth-access-tokens-enterprise) to improve security by reducing the risk of compromised passwords or personal access tokens.
### OAuth Access Tokens Enterprise[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#oauth-access-tokens-enterprise "Direct link to oauth-access-tokens-enterprise")
...
## Downloading and Installing[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#downloading-and-installing "Direct link to Downloading and Installing")
  * [Windows](/client-applications/drivers/arrow-flight-sql-odbc-driver#downloading-and-installing-on-windows)
  * [Linux](/client-applications/drivers/arrow-flight-sql-odbc-driver#downloading-and-installing-on-linux)
  * [macOS](/client-applications/drivers/arrow-flight-sql-odbc-driver#downloading-and-installing-on-macos)


### Downloading and Installing on Windows[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#downloading-and-installing-on-windows "Direct link to Downloading and Installing on Windows")
...
Next, [configure the driver](/client-applications/drivers/arrow-flight-sql-odbc-driver#configuring-on-windows).
### Downloading and Installing on Linux[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#downloading-and-installing-on-linux "Direct link to Downloading and Installing on Linux")
To download and install the Arrow Flight SQL ODBC driver:
...
Next, [configure the driver](/client-applications/drivers/arrow-flight-sql-odbc-driver#configuring-on-linux).
### Downloading and Installing on macOS[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#downloading-and-installing-on-macos "Direct link to Downloading and Installing on macOS")
To download and install the Arrow Flight SQL ODBC driver:
...
Next, [configure the driver](/client-applications/drivers/arrow-flight-sql-odbc-driver#configuring-on-macos).
## Configuring[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#configuring "Direct link to Configuring")
### Configuring on Windows[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#configuring-on-windows "Direct link to Configuring on Windows")
...
| **TOKEN**  | Do not specify  | Do not specify  | OAuth access token  |  
  7. In the **UseEncryption** field, specify one of these values:
     * `true`, if Dremio is configured for [encrypted communication](/client-applications/drivers/arrow-flight-sql-odbc-driver#tls-connection-parameters) with your Arrow Flight SQL ODBC client applications.
...
For additional parameters, see [Connection Parameters](/client-applications/drivers/arrow-flight-sql-odbc-driver#connection-parameters).
...
### Configuring on Linux[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#configuring-on-linux "Direct link to Configuring on Linux")
...
### Configuring on macOS[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#configuring-on-macos "Direct link to Configuring on macOS")
...
## Connection Parameters[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#connection-parameters "Direct link to Connection Parameters")
### Primary Connection Parameters[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#primary-connection-parameters "Direct link to Primary Connection Parameters")
...
| **PWD**  | Password  | Personal access token  | Do not specify  |  
| **TOKEN**  | Do not specify  | Do not specify  | OAuth access token  |  
### TLS Connection Parameters[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#tls-connection-parameters "Direct link to TLS Connection Parameters")
...
| useEncryption  | integer  | Configures the client to use a TLS-encrypted connection to communicate with the Dremio server. Accepted values: 
  * `true`, the client communicates with the Dremio server only using TLS encryption. This is the default value. Therefore, communication between the client application and your Dremio server must be encrypted if you do not override this default value. See the configuration of Arrow Flight TLS for [Dremio on Kubernetes](/deploy-dremio/configuring-kubernetes#transport-level-security) or [Dremio standalone clusters](/deploy-dremio/other-options/standalone/dremio-config/dremio-conf/wire-encryption-config#arrow-flight-and-arrow-flight-sql-jdbc-and-odbc-enterprise) for more information. 
...
### Advanced Parameters[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#advanced-parameters "Direct link to Advanced Parameters")  
| Name  | Type  | Description  | Default Value  |  
| --- | --- | --- | --- |  
...
## Logging[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#logging "Direct link to Logging")
...
## Supported Conversions from Dremio Datatypes to ODBC Datatypes[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#supported-conversions-from-dremio-datatypes-to-odbc-datatypes "Direct link to Supported Conversions from Dremio Datatypes to ODBC Datatypes")  
...
## Limitations[​](/client-applications/drivers/arrow-flight-sql-odbc-driver#limitations "Direct link to Limitations")
