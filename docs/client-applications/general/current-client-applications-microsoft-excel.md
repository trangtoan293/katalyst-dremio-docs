...
On this page
# Microsoft Excel
## Supported Versions[​](/client-applications/microsoft-excel#supported-versions "Direct link to Supported Versions")
Microsoft Excel version 16.95 (25030928) for Mac introduces a change that causes Excel to crash when using the Arrow Flight SQL ODBC driver. The crash occurs immediately after authentication, before the query/source selection dialog appears. This issue only affects Excel 16.95 on macOS. Excel on Windows is not impacted. See [Hiding the SQL Tables Listing](/client-applications/microsoft-excel#hiding-the-sql-tables-listing) for a fix.
Microsoft Excel in Microsoft 365
## Prerequisites[​](/client-applications/microsoft-excel#prerequisites "Direct link to Prerequisites")
...
## Connecting to Dremio[​](/client-applications/microsoft-excel#connecting-to-dremio "Direct link to Connecting to Dremio")
...
## Hiding the SQL Tables Listing[​](/client-applications/microsoft-excel#hiding-the-sql-tables-listing "Direct link to Hiding the SQL Tables Listing")
...
## Using the Extended Flight SQL Buffer[​](/client-applications/microsoft-excel#using-the-extended-flight-sql-buffer "Direct link to Using the Extended Flight SQL Buffer")
...
[Previous Looker](/client-applications/looker)[Next Microsoft Excel PowerPivot](/client-applications/microsoft-excel/microsoft-excel-powerpivot)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fclient-applications%2Fmicrosoft-excel%2F&_biz_t=1777950352203&_biz_i=Microsoft%20Excel%20%7C%20Dremio%20Documentation&_biz_n=62&rnd=103348&cdn_o=a&_biz_z=1777950352204)
