...
slug: /client-applications/microsoft-power-bi
...
The Power BI connector for Dremio now supports connectivity through the open-source Enable Connectivity with ADBC.
...
## Arrow Database Connectivity (ADBC) Limitations​ Limitations")
