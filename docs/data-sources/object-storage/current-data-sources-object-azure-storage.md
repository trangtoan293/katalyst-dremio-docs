...
slug: /data-sources/object/azure-storage
...
### Advanced Options​
  * **Enable partition column inference** : Select if Dremio should use [partition column inference](/developer/data-formats/table) to handle partition columns.
