...
## Supported Versions[​](/data-sources/databases/sql-server#supported-versions "Direct link to Supported Versions")
...
## Initial Connection[​](/data-sources/databases/sql-server#initial-connection "Direct link to Initial Connection")
...
## User Impersonation[​](/data-sources/databases/sql-server#user-impersonation "Direct link to User Impersonation")
...
In this example, the user can log in as `testuser1` in Dremio and in Microsoft SQL Server, and they can connect through the `proxyuser`. The `proxyuser` is the Microsoft SQL Server username provided in the source configuration.
  ...
  2. Follow the steps for [Configuring Microsoft SQL Server as a Source](/data-sources/databases/sql-server#configuring-microsoft-sql-server-as-a-source) using the Microsoft SQL Server username `proxyuser` and enable **User Impersonation** in the **Advanced Options**.
...
## Configuring Microsoft SQL Server as a Source[​](/data-sources/databases/sql-server#configuring-microsoft-sql-server-as-a-source "Direct link to Configuring Microsoft SQL Server as a Source")
...
### General[​](/data-sources/databases/sql-server#general "Direct link to General")
#### Name[​](/data-sources/databases/sql-server#name "Direct link to Name")
Enter the name to identify the data source in Dremio. The name cannot include the following special characters: `/`, `:`, `[`, or `]`.
#### Connection[​](/data-sources/databases/sql-server#connection "Direct link to Connection")
...
#### Authentication[​](/data-sources/databases/sql-server#authentication "Direct link to Authentication")
...
### Advanced Options[​](/data-sources/databases/sql-server#advanced-options "Direct link to Advanced Options")
...
### Reflection Refresh[​](/data-sources/databases/sql-server#reflection-refresh "Direct link to Reflection Refresh")
...
### Metadata[​](/data-sources/databases/sql-server#metadata "Direct link to Metadata")
#### Dataset Handling[​](/data-sources/databases/sql-server#dataset-handling "Direct link to Dataset Handling")
...
#### Metadata Refresh[​](/data-sources/databases/sql-server#metadata-refresh "Direct link to Metadata Refresh")
...
### Privileges[​](/data-sources/databases/sql-server#privileges "Direct link to Privileges")
...
## Updating a Microsoft SQL Server Source[​](/data-sources/databases/sql-server#updating-a-microsoft-sql-server-source "Direct link to Updating a Microsoft SQL Server Source")
To update a Microsoft SQL Server source:
  ...
  3. In the **Source Settings** dialog, edit the settings you wish to update. Dremio does not support updating the source name. For information about the settings options, see [Configuring Microsoft SQL Server as a Source](/data-sources/databases/sql-server#configuring-microsoft-sql-server-as-a-source).
  4. Click **Save**.


## Deleting a Microsoft SQL Server Source[​](/data-sources/databases/sql-server#deleting-a-microsoft-sql-server-source "Direct link to Deleting a Microsoft SQL Server Source")
...
## Predicate Pushdowns[​](/data-sources/databases/sql-server#predicate-pushdowns "Direct link to Predicate Pushdowns")
...
## Running Queries Directly on SQL Server Through Dremio[​](/data-sources/databases/sql-server#running-queries-directly-on-sql-server-through-dremio "Direct link to Running Queries Directly on SQL Server Through Dremio")
...
## For More Information[​](/data-sources/databases/sql-server#for-more-information "Direct link to For More Information")
...
[Previous Microsoft Azure Synapse Analytics](/data-sources/databases/azure-synapse-analytics)[Next MongoDB](/data-sources/databases/mongo)
