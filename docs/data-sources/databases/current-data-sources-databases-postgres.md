...
slug: /data-sources/databases/postgres
...
Add the file content to your `values-overrides.yaml` using the [`configFiles`](/deploy-dremio/configuring-kubernetes) option. The Helm chart will create a ConfigMap and mount it into the Dremio containers automatically.
