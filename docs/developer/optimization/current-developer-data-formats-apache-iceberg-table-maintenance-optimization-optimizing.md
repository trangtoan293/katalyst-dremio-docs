...
slug: /developer/data-formats/apache-iceberg/table-maintenance-optimization/optimizing
...
For unclustered tables, `OPTIMIZE TABLE` combines small files or splits large files to achieve an optimal file size, reducing metadata overhead and runtime file open costs. We recommend enabling automated table maintenance to eliminate the need to run optimizations for clustered Iceberg tables manually.
