...
If you are using Hive datasets, we recommend that you enable the `store.accurate.partition_stats` support key, which improves the accuracy of partition statistics. See [Support Settings](/help-support/support-settings/#support-keys) for the steps. Using these support keys enables new functionalities in Dremio that might cause unexpected behaviors with your existing datasets.
Metadata refreshes [take place automatically](/help-support/advanced-topics/metadata-caching/#when-automatic-refreshes-happen), [are scheduled](/help-support/advanced-topics/metadata-caching/#scheduling-metadata-refreshes), or [are triggered manually](/help-support/advanced-topics/metadata-caching/#triggering-metadata-refreshes-manually).
...
## When Automatic Refreshes Happen[​](/help-support/advanced-topics/metadata-caching/#when-automatic-refreshes-happen "Direct link to When Automatic Refreshes Happen")
...
## Scheduling Metadata Refreshes[​](/help-support/advanced-topics/metadata-caching/#scheduling-metadata-refreshes "Direct link to Scheduling Metadata Refreshes")
...
## Triggering Metadata Refreshes Manually[​](/help-support/advanced-topics/metadata-caching/#triggering-metadata-refreshes-manually "Direct link to Triggering Metadata Refreshes Manually")
You can manually trigger an immediate metadata refresh by executing the SQL command `ALTER TABLE `table` REFRESH METADATA`.
To ensure a new recently-written metadata is identified by Dremio, run the [ALTER TABLE](/reference/sql/commands/alter-table) SQL command in an on-demand basis, which guarantees that the most-recent metadata changes are identified. Using [the syntax specified here](/reference/sql/commands/alter-table), you may also refresh metadata for [individual partitions](/help-support/advanced-topics/metadata-caching/#refreshing-partition-metadata).
...
### Refreshing Partition Metadata[​](/help-support/advanced-topics/metadata-caching/#refreshing-partition-metadata "Direct link to Refreshing Partition Metadata")
...
## Limitations in How Metadata is Refreshed[​](/help-support/advanced-topics/metadata-caching/#limitations-in-how-metadata-is-refreshed "Direct link to Limitations in How Metadata is Refreshed")
...
[Previous Ranger-Based Authorization](/help-support/advanced-topics/hive-ranger)[Next Runtime Filtering](/help-support/advanced-topics/runtime-filtering)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fadmin%2Fmonitoring%2Fjobs%2Foverview%2F&_biz_t=1777951091135&_biz_i=Overview%20%7C%20Dremio%20Documentation&_biz_n=1502&rnd=514206&cdn_o=a&_biz_z=1777951091138)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fhelp-support%2Fadvanced-topics%2Fmetadata-caching%2F&_biz_t=1777951091137&_biz_i=Refreshing%20Metadata%20%7C%20Dremio%20Documentation&_biz_n=1503&rnd=458799&cdn_o=a&_biz_z=1777951091138)
