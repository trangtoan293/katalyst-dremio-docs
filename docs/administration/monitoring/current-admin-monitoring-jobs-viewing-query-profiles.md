...
slug: /admin/monitoring/jobs/viewing-query-profiles
...
## Visual Profiles[​](/admin/monitoring/jobs/viewing-query-profiles/)
...
## Phases[​](/admin/monitoring/jobs/viewing-query-profiles/)
...
## Using Visual Profiles[​](/admin/monitoring/jobs/viewing-query-profiles/)
...
## Benefits of Visual Profiles[​](/admin/monitoring/jobs/viewing-query-profiles/)
...
## Use Cases[​](/admin/monitoring/jobs/viewing-query-profiles/)
### Improving the Performance of Queries[​](/admin/monitoring/jobs/viewing-query-profiles/)
...
### Reducing Query-Execution Costs[​](/admin/monitoring/jobs/viewing-query-profiles/)
