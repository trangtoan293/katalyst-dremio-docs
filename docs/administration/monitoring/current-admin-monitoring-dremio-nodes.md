...
slug: /admin/monitoring/dremio-nodes
...
There are various approaches for operational monitoring of Dremio nodes. This topic discusses both:
  ...
  * [`queries.json`](/admin/monitoring/), a log file generated by Dremio, which can be used to calculate various service-level agreements (SLAs) related to query performance.
...
### Enabling Node Metrics[​](/admin/monitoring/dremio-nodes/)
...
### Available Prometheus Metrics[​](/admin/monitoring/dremio-nodes/)
...
## Parameters to Monitor for Scaling Capacity[​](/admin/monitoring/dremio-nodes/)
...
### Query Execution Errors[​](/admin/monitoring/dremio-nodes/)
...
### Job State Durations[​](/admin/monitoring/dremio-nodes/)
Use the [job state durations](/admin/monitoring/jobs/) (provided in milliseconds) in the `queries.json` to address SLA breaches.  
