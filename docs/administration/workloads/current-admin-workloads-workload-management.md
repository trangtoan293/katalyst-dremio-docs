...
### Homogeneous Environment[​](/admin/workloads/workload-management/#homogeneous-environment "Direct link to Homogeneous Environment")
...
## How Workload Management Works[​](/admin/workloads/workload-management/#how-workload-management-works "Direct link to How Workload Management Works")
...
![](https://docs.dremio.com/assets/images/wlm-flow-21b62373088be9e75494e9d667c2d260.png)
## Queues[​](/admin/workloads/workload-management/#queues "Direct link to Queues")
...
### Default Queues[​](/admin/workloads/workload-management/#default-queues "Direct link to Default Queues")
...
Concurrency limit: 1  |  
### Queue and Job Limits[​](/admin/workloads/workload-management/#queue-and-job-limits "Direct link to Queue and Job Limits")
...
## Rules[​](/admin/workloads/workload-management/#rules "Direct link to Rules")
...
### Rule Configuration Options[​](/admin/workloads/workload-management/#rule-configuration-options "Direct link to Rule Configuration Options")  
...
## Rule Examples[​](/admin/workloads/workload-management/#rule-examples "Direct link to Rule Examples")
...
### User[​](/admin/workloads/workload-management/#user "Direct link to User")
...
### Group Membership[​](/admin/workloads/workload-management/#group-membership "Direct link to Group Membership")
...
### Query Label[​](/admin/workloads/workload-management/#query-label "Direct link to Query Label")
...
Here is an example of a rule in the New Rule dialog: ![](https://docs.dremio.com/assets/images/query-label-example-rule-ee3b781488dc47ad465f0955bbc1069f.png)
### Query Attributes[​](/admin/workloads/workload-management/#query-attributes "Direct link to Query Attributes")
...
### Query Type[​](/admin/workloads/workload-management/#query-type "Direct link to Query Type")
...
### Query Plan Cost[​](/admin/workloads/workload-management/#query-plan-cost "Direct link to Query Plan Cost")
...
### Tag[​](/admin/workloads/workload-management/#tag "Direct link to Tag")
...
### Date and Time[​](/admin/workloads/workload-management/#date-and-time "Direct link to Date and Time")
...
### Combined Conditions[​](/admin/workloads/workload-management/#combined-conditions "Direct link to Combined Conditions")
...
### Default Rules[​](/admin/workloads/workload-management/#default-rules "Direct link to Default Rules")
...
## Viewing All Rules[​](/admin/workloads/workload-management/#viewing-all-rules "Direct link to Viewing All Rules")
To view all rules:
...
## Adding a Rule[​](/admin/workloads/workload-management/#adding-a-rule "Direct link to Adding a Rule")
To add a rule:
  1. On the Engine Routing page, click **+ Add Rule** in the top left.
  2. In the **New Rule** dialog, for **Rule Name** , enter a name.
  3. For **Conditions** , enter the routing condition. See [Rules](/admin/workloads/workload-management/#rules) for supported conditions.
...
## Editing a Rule[​](/admin/workloads/workload-management/#editing-a-rule "Direct link to Editing a Rule")
To edit a rule:
...
## Deleting a Rule[​](/admin/workloads/workload-management/#deleting-a-rule "Direct link to Deleting a Rule")
To delete a rule:
...
## Per Session Configuration[​](/admin/workloads/workload-management/#per-session-configuration "Direct link to Per Session Configuration")
...
### SET QUEUE[​](/admin/workloads/workload-management/#set-queue "Direct link to SET QUEUE")
...
### SET TAG[​](/admin/workloads/workload-management/#set-tag "Direct link to SET TAG")
...
## Direct Routing[​](/admin/workloads/workload-management/#direct-routing "Direct link to Direct Routing")
...
## Connection Tagging and Direct Routing Configuration[​](/admin/workloads/workload-management/#connection-tagging-and-direct-routing-configuration "Direct link to Connection Tagging and Direct Routing Configuration")
...
### JDBC Session Configuration[​](/admin/workloads/workload-management/#jdbc-session-configuration "Direct link to JDBC Session Configuration")
...
### ODBC Session Configuration[​](/admin/workloads/workload-management/#odbc-session-configuration "Direct link to ODBC Session Configuration")
...
#### Tableau .tds File Configuration[​](/admin/workloads/workload-management/#tableau-tds-file-configuration "Direct link to Tableau .tds File Configuration")
...
## Multi-Cluster Isolation[​](/admin/workloads/workload-management/#multi-cluster-isolation "Direct link to Multi-Cluster Isolation")
Multi-cluster isolation allows you to isolate your workload by grouping nodes into virtual clusters.
### Setup and Configuration[​](/admin/workloads/workload-management/#setup-and-configuration "Direct link to Setup and Configuration")
...
### Viewing and Assigning[​](/admin/workloads/workload-management/#viewing-and-assigning "Direct link to Viewing and Assigning")
...
## Best Practices for Workload Management[​](/admin/workloads/workload-management/#best-practices-for-workload-management "Direct link to Best Practices for Workload Management")
...
### Configuration Models[​](/admin/workloads/workload-management/#configuration-models "Direct link to Configuration Models")
...
#### Single-Engine Configuration[​](/admin/workloads/workload-management/#single-engine-configuration "Direct link to Single-Engine Configuration")
...
#### Multi-Engine Configuration[​](/admin/workloads/workload-management/#multi-engine-configuration "Direct link to Multi-Engine Configuration")
...
### Workload Routing[​](/admin/workloads/workload-management/#workload-routing "Direct link to Workload Routing")
...
### Using the sys.jobs_recent` System Table[​](/admin/workloads/workload-management/#using-the-sysjobs_recent-system-table "Direct link to Using the sys.jobs_recent` System Table")
