---
url: /admin/workloads
slug: /admin/workloads
title: "Managing Job Workloads | Dremio Enterprise Documentation"
depth: 2
crawled_at: 64025.727902333
---
...
Dremio job workloads are managed differently depending on which edition (Enterprise or Community) you are using.
  * [Job History & Job Details](/admin/monitoring/jobs) The results of each query, or job, is displayed here in table format. Individual job details may be viewed by clicking on each row.
...
[Previous Monitoring](/admin/monitoring)[Next Queue Control](/admin/workloads/job-queues)
