...
The AI Agent is currently optimized for the following tasks:
  ...
  * **Analyze and Improve Job Performance** : Ask the agent to review past jobs, identify performance issues, and suggest ways to improve them. For more information on this, see [**Explain Job**](/admin/monitoring/jobs/).
