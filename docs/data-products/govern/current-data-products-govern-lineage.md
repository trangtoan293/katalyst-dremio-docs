...
If you wish to track lineage for a different dataset node, the lineage graph needs to be refocused. To refocus the lineage graph on a different dataset, click ![](https://docs.dremio.com/images/icons/more.png) on the right of the dataset name, and then select **Focus on this dataset**.
...
## Privileges Required for Lineage[​](/data-products/govern/lineage#privileges-required-for-lineage "Direct link to Privileges Required for Lineage")
...
## Lineage Refresh with Dataset Schema Changes[​](/data-products/govern/lineage#lineage-refresh-with-dataset-schema-changes "Direct link to Lineage Refresh with Dataset Schema Changes")
For datasets in [Spaces](/what-is-dremio/key-concepts#spaces-and-folders), the lineage graphs are automatically refreshed whenever the dataset schema updates are saved.
