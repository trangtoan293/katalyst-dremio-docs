...
slug: /deploy-dremio/other-options/yarn-hadoop
...
## Step 4: (Optional) Configuring for Name Node HA and Resource Manager HA​ Configuring for Name Node HA and Resource Manager HA")
...
[Previous Other Options](/deploy-dremio/other-options)Next Dremio with Your Infrastructure
