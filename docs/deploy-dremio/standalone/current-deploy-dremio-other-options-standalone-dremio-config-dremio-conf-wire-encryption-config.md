...
slug: /deploy-dremio/other-options/standalone/dremio-config/dremio-conf/wire-encryption-config
...
All Dremio clusters must have the following configured:
  * One or more coordinator nodes with the main coordinator role. See High Availability in Cluster Deloyments for a multiple coordinator node environment.
...
### Legacy JDBC Clients Enterprise​
...
Previous Cloud CacheNext ZooKeeper
