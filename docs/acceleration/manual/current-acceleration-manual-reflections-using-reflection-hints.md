...
## How Reflections are Substituted for Tables and Views[​](/acceleration/manual-reflections/using-reflection-hints#how-reflections-are-substituted-for-tables-and-views "Direct link to How Reflections are Substituted for Tables and Views")
...
### 1. Consider[​](/acceleration/manual-reflections/using-reflection-hints#1-consider "Direct link to 1. Consider")
...
### 2. Match[​](/acceleration/manual-reflections/using-reflection-hints#2-match "Direct link to 2. Match")
...
### 3. Choose[​](/acceleration/manual-reflections/using-reflection-hints#3-choose "Direct link to 3. Choose")
...
## Types of Reflection Hints[​](/acceleration/manual-reflections/using-reflection-hints#types-of-reflection-hints "Direct link to Types of Reflection Hints")
The types of hints are listed in the order in which they are applied.
### consider_reflections[​](/acceleration/manual-reflections/using-reflection-hints#consider_reflections "Direct link to consider_reflections")
...
### exclude_reflections[​](/acceleration/manual-reflections/using-reflection-hints#exclude_reflections "Direct link to exclude_reflections")
...
### no_reflections[​](/acceleration/manual-reflections/using-reflection-hints#no_reflections "Direct link to no_reflections")
...
### choose_reflections[​](/acceleration/manual-reflections/using-reflection-hints#choose_reflections "Direct link to choose_reflections")
...
### current_iceberg_data_only[​](/acceleration/manual-reflections/using-reflection-hints#current_iceberg_data_only "Direct link to current_iceberg_data_only")
...
## Scope of Reflection Hints[​](/acceleration/manual-reflections/using-reflection-hints#scope-of-reflection-hints "Direct link to Scope of Reflection Hints")
...
### Setting Hints in Sessions[​](/acceleration/manual-reflections/using-reflection-hints#setting-hints-in-sessions "Direct link to Setting Hints in Sessions")
...
### Setting Hints in Views[​](/acceleration/manual-reflections/using-reflection-hints#setting-hints-in-views "Direct link to Setting Hints in Views")
...
### Setting Hints in Queries[​](/acceleration/manual-reflections/using-reflection-hints#setting-hints-in-queries "Direct link to Setting Hints in Queries")
...
## Obtaining Reflection IDs[​](/acceleration/manual-reflections/using-reflection-hints#obtaining-reflection-ids "Direct link to Obtaining Reflection IDs")
...
To find the ID of a Reflection by using REST APIs:
  1. Obtain the ID of the table or view that the Reflection was defined on by using retrieving either the [table](/reference/api/catalog/table#retrieve-a-table-by-path) or [view](/reference/api/catalog/view#retrieve-a-view-by-path) by its path.
  2. [Use the Reflections API to retrieve a list of all of the Reflections that are defined on the table or view](/reference/api/reflections#retrieve-all-reflections-for-a-dataset).
...
[Previous View Whether Queries Used Reflections](/acceleration/manual-reflections/info-about-queries)[Next Refresh Reflections](/acceleration/manual-reflections/refreshing-reflections)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Facceleration%2Fmanual-reflections%2Fusing-reflection-hints%2F&_biz_t=1777950508152&_biz_i=Use%20Reflection%20Hints%20%7C%20Dremio%20Documentation&_biz_n=366&rnd=20137&cdn_o=a&_biz_z=1777950508152)
