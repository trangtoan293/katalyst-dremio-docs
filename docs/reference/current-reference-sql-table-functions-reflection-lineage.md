...
slug: /reference/sql/table-functions/reflection-lineage
...
The ID of the Reflection. If you need to find a Reflection ID, see [Obtaining Reflection IDs](/acceleration/manual-reflections/using-reflection-hints).
## Example​
