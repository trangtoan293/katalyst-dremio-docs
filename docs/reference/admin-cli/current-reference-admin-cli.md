...
## Commands[​](/reference/admin-cli#commands "Direct link to Commands")  
| Command  | Description  |  
| --- | --- |  
...
## Log Directory[​](/reference/admin-cli#log-directory "Direct link to Log Directory")
...
## Log Verbosity[​](/reference/admin-cli#log-verbosity "Direct link to Log Verbosity")
...
## For More Information[​](/reference/admin-cli#for-more-information "Direct link to For More Information")
