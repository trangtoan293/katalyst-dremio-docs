...
slug: /reference/sql/sql-functions/functions/GEO_NEARBY
...
## Syntax
### GEO_NEARBY(_lat1_ float, _lon1_ float, _lat2_ float, _lon2_ float, _distance_ double) → boolean[​](/reference/sql/sql-functions)
