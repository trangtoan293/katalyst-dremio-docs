...
### MONTHS_BETWEEN(_date_timestamp_expression1_ string, _date_timestamp_expression2_ string) → float[​](/reference/sql/sql-functions#months_betweendate_timestamp_expression1-string-date_timestamp_expression2-string--float "Direct link to months_betweendate_timestamp_expression1-string-date_timestamp_expression2-string--float")
