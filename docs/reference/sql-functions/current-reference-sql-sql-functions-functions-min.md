...
slug: /reference/sql/sql-functions/functions/MIN
...
## Syntax
### MIN(_expression_ NUMERIC) → NUMERIC[​](/reference/sql/sql-functions)
...
The MIN function supports optional `PARTITION BY`, `ORDER_BY`, and cumulative and sliding window frame subclauses. See [Window Functions](/reference/sql/sql-functions) for more information and syntax.
