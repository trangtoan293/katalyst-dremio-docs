...
slug: /reference/sql/sql-functions/functions/IMINDIR
...
## Syntax
### IMINDIR('dfs', '`path_of_parent_directory`') → `name_of_subdirectory`[​](/reference/sql/sql-functions) → `name_of_subdirectory`")
