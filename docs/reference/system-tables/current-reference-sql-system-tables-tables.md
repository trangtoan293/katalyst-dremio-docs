...
## Example Output[​](/reference/sql/system-tables/tables#example-output "Direct link to Example Output")  
...
## Columns[​](/reference/sql/system-tables/tables#columns "Direct link to Columns")  
