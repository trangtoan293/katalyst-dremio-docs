...
On this page
# Wiki
Use the Catalog API to create, update, and retrieve the [wiki](/data-products/govern/wikis-tags#wikis) for a source, space, or dataset.
Wiki Object
...
## Wiki Attributes[​](/reference/api/catalog/wiki#wiki-attributes "Direct link to Wiki Attributes")
text String
...
Example: 4
## Create a Wiki[​](/reference/api/catalog/wiki#create-a-wiki "Direct link to Create a Wiki")
...
### Parameters[​](/reference/api/catalog/wiki#parameters "Direct link to Parameters")
...
### Example[​](/reference/api/catalog/wiki#example "Direct link to Example")
Request
...
### Response Status Codes[​](/reference/api/catalog/wiki#response-status-codes "Direct link to Response Status Codes")
200 OK   
...
## Retrieve a Wiki[​](/reference/api/catalog/wiki#retrieve-a-wiki "Direct link to Retrieve a Wiki")
...
### Parameters[​](/reference/api/catalog/wiki#parameters-1 "Direct link to Parameters")
object-id Path String (UUID)
Unique identifier of the source, space, or dataset whose wiki you want to retrieve.
Example: 1bcab7b3-ee82-44c1-abcc-e86d56078d4d
### Example[​](/reference/api/catalog/wiki#example-1 "Direct link to Example")
Request
...
### Response Status Codes[​](/reference/api/catalog/wiki#response-status-codes-1 "Direct link to Response Status Codes")
200 OK   
...
## Update a Wiki[​](/reference/api/catalog/wiki#update-a-wiki "Direct link to Update a Wiki")
...
### Parameters[​](/reference/api/catalog/wiki#parameters-2 "Direct link to Parameters")
object-id Path String (UUID)
...
Example: 0
### Example[​](/reference/api/catalog/wiki#example-2 "Direct link to Example")
Request
...
### Response Status Codes[​](/reference/api/catalog/wiki#response-status-codes-2 "Direct link to Response Status Codes")
200 OK   
...
## Delete a Wiki[​](/reference/api/catalog/wiki#delete-a-wiki "Direct link to Delete a Wiki")
...
### Parameters[​](/reference/api/catalog/wiki#parameters-3 "Direct link to Parameters")
object-id Path String (UUID)
...
Example: 1
### Example[​](/reference/api/catalog/wiki#example-3 "Direct link to Example")
Request
...
### Response Status Codes[​](/reference/api/catalog/wiki#response-status-codes-3 "Direct link to Response Status Codes")
200 OK   
...
[Previous Tag](/reference/api/catalog/tag)[Next Grants](/reference/api/catalog/grants)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Freference%2Fapi%2Fcatalog%2Fwiki%2F&_biz_t=1777950557650&_biz_i=Wiki%20%7C%20Dremio%20Documentation&_biz_n=460&rnd=306251&cdn_o=a&_biz_z=1777950557650)
