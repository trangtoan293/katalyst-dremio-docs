...
slug: /reference/api/catalog/container-home
...
On this page
# Home
Use the Catalog API to retrieve information about the [home space](/what-is-dremio/key-concepts) and the child objects it contains.
Home Object
...
## Retrieve the Home Space by Path​
