...
On this page
# Space
Use the Catalog API to retrieve information about [spaces](/what-is-dremio/key-concepts#spaces-and-folders) and the child objects they contain, as well as to create, update, and delete spaces.
Space Object
...
## Space Attributes[​](/reference/api/catalog/container-space#space-attributes "Direct link to Space Attributes")
entityType String
...
* * *
[children](/reference/api/catalog/container-space#attributes-of-objects-in-the-children-array) Array of Object
...
* * *
[accessControlList](/reference/api/catalog/container-space#attributes-of-the-accesscontrollist-object) Object
...
* * *
[owner](/reference/api/catalog/container-space#attributes-of-the-owner-object) Object
Information about the space's owner.
Example: {'{'}'{'{'}'{'}'})'{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'})"ownerId": "d01585a2-b267-4d56-9154-31762ab65a43","ownerType": "USER"{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'}'{'{'}'{'}'}'{'}'}
#### Attributes of Objects in the `children` Array[​](/reference/api/catalog/container-space#attributes-of-objects-in-the-children-array "Direct link to attributes-of-objects-in-the-children-array")
id String (UUID)
...
#### Attributes of the `accessControlList` Object[​](/reference/api/catalog/container-space#attributes-of-the-accesscontrollist-object "Direct link to attributes-of-the-accesscontrollist-object")
[users](/reference/api/catalog/container-space#attributes-of-objects-in-the-users-and-roles-arrays) Array of Object
...
* * *
[roles](/reference/api/catalog/container-space#attributes-of-objects-in-the-users-and-roles-arrays) Array of Object
...
#### Attributes of the `owner` Object[​](/reference/api/catalog/container-space#attributes-of-the-owner-object "Direct link to attributes-of-the-owner-object")
ownerId String (UUID)
...
Enum: USER, ROLE
Example: USER
##### Attributes of Objects in the `users` and `roles` Arrays[​](/reference/api/catalog/container-space#attributes-of-objects-in-the-users-and-roles-arrays "Direct link to attributes-of-objects-in-the-users-and-roles-arrays")
id String (UUID)
...
Example: ["MODIFY"]
## Create a Space[​](/reference/api/catalog/container-space#create-a-space "Direct link to Create a Space")
Create a new space.
Method and URL
...
### Parameters[​](/reference/api/catalog/container-space#parameters "Direct link to Parameters")
...
Example: Example-Space
* * *
[accessControlList](/reference/api/catalog/container-space#parameters-of-the-accesscontrollist-object) Body Object Optional
...
Example: {'{'}'{'{'}'{'}'})'{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'})"users": [{'{'}'{'{'}'{'}'})'{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'})"id": "737a038f-c6cd-4fd3-a77a-59f692727ba5","permissions": ["MODIFY"]{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'}'{'{'}'{'}'}'{'}'}],"roles": [{'{'}'{'{'}'{'}'})'{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'})"id": "0f2d94e0-bb5e-4c03-8c6f-62d379d10889","permissions": ["MODIFY"]{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'}'{'{'}'{'}'}'{'}'}]{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'}'{'{'}'{'}'}'{'}'}
#### Parameters of the `accessControlList` Object[​](/reference/api/catalog/container-space#parameters-of-the-accesscontrollist-object "Direct link to parameters-of-the-accesscontrollist-object")
[users](/reference/api/catalog/container-space#parameters-of-objects-in-the-users-and-roles-arrays) Body Array of Object Optional
Enterprise only. List of users who should have access to the space and the specific privileges each user should have.
Example: [{'{'}'{'{'}'{'}'})'{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'})"id": "737a038f-c6cd-4fd3-a77a-59f692727ba5","permissions": ["MODIFY"]{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'}'{'{'}'{'}'}'{'}'}]
* * *
[roles](/reference/api/catalog/container-space#parameters-of-objects-in-the-users-and-roles-arrays) Body Array of Object Optional
...
Example: [{'{'}'{'{'}'{'}'})'{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'})"id": "0f2d94e0-bb5e-4c03-8c6f-62d379d10889","permissions": ["MODIFY"]{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'}'{'{'}'{'}'}'{'}'}]
##### Parameters of Objects in the `users` and `roles` Arrays[​](/reference/api/catalog/container-space#parameters-of-objects-in-the-users-and-roles-arrays "Direct link to parameters-of-objects-in-the-users-and-roles-arrays")
...
Enum: ALL, VIEW_REFLECTION, TRUNCATE, UPDATE, DELETE, DROP, MANAGE_GRANTS, EXTERNAL_QUERY, EXECUTE, ALTER, INSERT, MODIFY, SELECT, CREATE_SOURCE, WRITE, CREATE_TABLE, ALTER_REFLECTION, READ
Example: ["MODIFY"]
### Example[​](/reference/api/catalog/container-space#example "Direct link to Example")
Request
...
### Response Status Codes[​](/reference/api/catalog/container-space#response-status-codes "Direct link to Response Status Codes")
200 OK   
...
## Retrieve a Space by ID[​](/reference/api/catalog/container-space#retrieve-a-space-by-id "Direct link to Retrieve a Space by ID")
...
### Parameters[​](/reference/api/catalog/container-space#parameters-1 "Direct link to Parameters")
id Path String (UUID)
...
### Response Status Codes[​](/reference/api/catalog/container-space#response-status-codes-1 "Direct link to Response Status Codes")
200 OK   
...
## Retrieve a Space by Path[​](/reference/api/catalog/container-space#retrieve-a-space-by-path "Direct link to Retrieve a Space by Path")
...
### Parameters[​](/reference/api/catalog/container-space#parameters-2 "Direct link to Parameters")
path Path String
...
* * *
maxChildren Query Integer Optional
Specify the maximum number of child objects to include in each page of results. Use in concert with the [pageToken query parameter](/reference/api/catalog/container-space#pagetokenqueryparam1) to split large sets of results into multiple pages. For more information, read [maxChildren Query Parameter](/reference/api#maxchildren-query-parameter).
Example: ?maxChildren=25
* * *
pageToken Query String Optional
Specify the token for retrieving the next page of results. Must be used in concert with the [maxChildren query parameter](/reference/api/catalog/container-space#maxchildrenqueryparam1): the first request URL includes maxChildren set to the maximum number of child objects to include in each page of results. If the space has more child objects than the specified maxChildren value, the response includes a nextPageToken attribute. Add the pageToken query parameter with the nextPageToken value to the request URL to retrieve the next page of results. Do not remove or change the maxChildren query parameter when you add pageToken to the request URL. Read [pageToken Query Parameter: User-Specified Maximum](/reference/api#user-specified-maximum) for more information.
Example: ?pageToken=cHAAFLceQCKsTVpwaEVisqgjDntZJUCuTqVNghPdkyBDUNoJvwrEXAMPLE
### Example[​](/reference/api/catalog/container-space#example-2 "Direct link to Example")
Request
...
### Response Status Codes[​](/reference/api/catalog/container-space#response-status-codes-2 "Direct link to Response Status Codes")
200 OK   
...
## Update a Space[​](/reference/api/catalog/container-space#update-a-space "Direct link to Update a Space")
...
### Parameters[​](/reference/api/catalog/container-space#parameters-3 "Direct link to Parameters")
id Path String (UUID)
...
Example: zzOQfjY9lU0=
* * *
[accessControlList](/reference/api/catalog/container-space#parameters-of-the-accesscontrollist-object-1) Body String Optional
...
#### Parameters of the `accessControlList` Object[​](/reference/api/catalog/container-space#parameters-of-the-accesscontrollist-object-1 "Direct link to parameters-of-the-accesscontrollist-object-1")
[users](/reference/api/catalog/container-space#parameters-of-objects-in-the-users-and-roles-arrays-1) Body Array of Object Optional
...
* * *
[roles](/reference/api/catalog/container-space#parameters-of-objects-in-the-users-and-roles-arrays-1) Body Array of Object Optional
...
Example: [{'{'}'{'{'}'{'}'})'{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'})"id": "0f2d94e0-bb5e-4c03-8c6f-62d379d10889", "permissions": ["MODIFY"]{'{'}'{'{'}'{'}'})'{'{'}'{'}'}'{'}'}'{'{'}'{'}'}'{'}'}]
#### Parameters of Objects in the `users` and `roles` Arrays[​](/reference/api/catalog/container-space#parameters-of-objects-in-the-users-and-roles-arrays-1 "Direct link to parameters-of-objects-in-the-users-and-roles-arrays-1")
id Body String Optional
Enterprise only. Unique identifier of the user or role who should have access to the space.
Example: 737a038f-c6cd-4fd3-a77a-59f692727ba5
* * *
...
Enum: ALL, VIEW_REFLECTION, TRUNCATE, UPDATE, DELETE, DROP, MANAGE_GRANTS, EXTERNAL_QUERY, EXECUTE, ALTER, INSERT, MODIFY, SELECT, CREATE_SOURCE, WRITE, CREATE_TABLE, ALTER_REFLECTION, READ
Example: ["ALL"]
### Example[​](/reference/api/catalog/container-space#example-3 "Direct link to Example")
Request
...
### Response Status Codes[​](/reference/api/catalog/container-space#response-status-codes-3 "Direct link to Response Status Codes")
200 OK   
...
## Delete a Space[​](/reference/api/catalog/container-space#delete-a-space "Direct link to Delete a Space")
...
### Parameters[​](/reference/api/catalog/container-space#parameters-4 "Direct link to Parameters")
id Path String (UUID)
Unique identifier of the space that you want to delete.
Example: 5442c00a-ada1-48c6-82fc-bb804b2e04e0
### Example[​](/reference/api/catalog/container-space#example-4 "Direct link to Example")
Request
...
### Response Status Codes[​](/reference/api/catalog/container-space#response-status-codes-4 "Direct link to Response Status Codes")
204 No Content   
...
[Previous Home](/reference/api/catalog/container-home)[Next Folder](/reference/api/catalog/container-folder)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Freference%2Fapi%2Fcatalog%2Fcontainer-space%2F&_biz_t=1777950385122&_biz_i=Space%20%7C%20Dremio%20Documentation&_biz_n=143&rnd=400624&cdn_o=a&_biz_z=1777950385123)
