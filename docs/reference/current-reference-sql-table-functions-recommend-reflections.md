...
slug: /reference/sql/table-functions/recommend-reflections
...
On this page
# SYS.RECOMMEND_REFLECTIONS
Returns a table of one or more recommendations. For more information, see [Reflection Recommendations](/acceleration/manual-reflections).
Syntax
