...
![](https://docs.dremio.com/images/kubernetes-architecture.png)
...
## Namespace[​](/what-is-dremio/architecture#namespace "Direct link to Namespace")
...
## Core Services[​](/what-is-dremio/architecture#core-services "Direct link to Core Services")
...
### Main Coordinator[​](/what-is-dremio/architecture#main-coordinator "Direct link to Main Coordinator")
...
### Scale-Out Coordinators[​](/what-is-dremio/architecture#scale-out-coordinators "Direct link to Scale-Out Coordinators")
...
### Load Balancer[​](/what-is-dremio/architecture#load-balancer "Direct link to Load Balancer")
...
### Engines[​](/what-is-dremio/architecture#engines "Direct link to Engines")
...
#### Workload Management[​](/what-is-dremio/architecture#workload-management "Direct link to Workload Management")
...
#### Cloud Columnar Cache[​](/what-is-dremio/architecture#cloud-columnar-cache "Direct link to Cloud Columnar Cache")
...
## Auxiliary Services[​](/what-is-dremio/architecture#auxiliary-services "Direct link to Auxiliary Services")
...
### Open Catalog[​](/what-is-dremio/architecture#open-catalog "Direct link to Open Catalog")
...
### AI-Enabled Semantic Search[​](/what-is-dremio/architecture#ai-enabled-semantic-search "Direct link to AI-Enabled Semantic Search")
...
### Metastore[​](/what-is-dremio/architecture#metastore "Direct link to Metastore")
...
### Secured Telemetry[​](/what-is-dremio/architecture#secured-telemetry "Direct link to Secured Telemetry")
...
### Distributed Storage[​](/what-is-dremio/architecture#distributed-storage "Direct link to Distributed Storage")
...
### High Availability[​](/what-is-dremio/architecture#high-availability "Direct link to High Availability")
