...
[Skip to main content](/acceleration/autonomous-reflections#__docusaurus_skipToContent_fallback)
...
## Enable Autonomous Reflections[​](/acceleration/autonomous-reflections#enable-autonomous-reflections "Direct link to Enable Autonomous Reflections")
...
## Set the Refresh Engine and Routing Rule for Autonomous Reflections[​](/acceleration/autonomous-reflections#set-the-refresh-engine-and-routing-rule-for-autonomous-reflections "Direct link to Set the Refresh Engine and Routing Rule for Autonomous Reflections")
...
## Behavior[​](/acceleration/autonomous-reflections#behavior "Direct link to Behavior")
...
When Dremio determines that a Reflection has a low score, it is not immediately dropped. Instead:
  ...
  * Admins can then view disabled Reflections through the [Autonomous Reflection History Log](/acceleration/autonomous-reflections#view-history-log-for-autonomous-reflections).


For [Aggregation Reflections](/acceleration#types), Dremio creates system-managed views that cannot be modified or referenced by other views. Admin users can drop these views, but doing also deletes the associated Reflection.
...
## Limits[​](/acceleration/autonomous-reflections#limits "Direct link to Limits")
...
## View History Log for Autonomous Reflections[​](/acceleration/autonomous-reflections#view-history-log-for-autonomous-reflections "Direct link to View History Log for Autonomous Reflections")
...
[Previous Accelerate Queries](/acceleration)[Next Manually Manage Reflections](/acceleration/manual-reflections)
  * [Enable Autonomous Reflections](/acceleration/autonomous-reflections#enable-autonomous-reflections)
  * [Set the Refresh Engine and Routing Rule for Autonomous Reflections](/acceleration/autonomous-reflections#set-the-refresh-engine-and-routing-rule-for-autonomous-reflections)
  * [Behavior](/acceleration/autonomous-reflections#behavior)
  * [Limits](/acceleration/autonomous-reflections#limits)
  * [View History Log for Autonomous Reflections](/acceleration/autonomous-reflections#view-history-log-for-autonomous-reflections)


![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Facceleration%2Fautonomous-reflections%2F&_biz_t=1777950339512&_biz_i=Autonomous%20Reflections%20%7C%20Dremio%20Documentation&_biz_n=39&rnd=645243&cdn_o=a&_biz_z=1777950339513)
