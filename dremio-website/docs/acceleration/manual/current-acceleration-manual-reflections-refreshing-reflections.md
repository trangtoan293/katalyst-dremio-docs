...
## Types of Reflection Refresh[​](/acceleration/manual-reflections/refreshing-reflections#types-of-reflection-refresh "Direct link to Types of Reflection Refresh")
How Reflections are refreshed depend on the format of the base table.
### Types of Refresh for Reflections on Apache Iceberg Tables and on Certain Types of Datasets in Filesystem Sources, AWS Glue Sources, and Hive Sources[​](/acceleration/manual-reflections/refreshing-reflections#types-of-refresh-for-reflections-on-apache-iceberg-tables-and-on-certain-types-of-datasets-in-filesystem-sources-aws-glue-sources-and-hive-sources "Direct link to Types of Refresh for Reflections on Apache Iceberg Tables and on Certain Types of Datasets in Filesystem Sources, AWS Glue Sources, and Hive Sources")
...
Iceberg tables in all supported file-system sources (Amazon S3, Azure Storage, Google Cloud Storage, and HDFS) and non-file-system sources (AWS Glue, Hive, and Nessie) can be refreshed with either of these methods.
  * [Incremental refreshes](/acceleration/manual-reflections/refreshing-reflections#incremental-refreshes)
  * [Full refreshes](/acceleration/manual-reflections/refreshing-reflections#full-refreshes)


#### Incremental Refreshes[​](/acceleration/manual-reflections/refreshing-reflections#incremental-refreshes "Direct link to Incremental Refreshes")
There are two types of incremental refreshes:
  * [Incremental refreshes when changes to an anchor table are only append operations](/acceleration/manual-reflections/refreshing-reflections#incremental-refreshes-when-changes-to-an-anchor-table-are-only-append-operations)
  * [Incremental refreshes when changes to an anchor table include non-append operations](/acceleration/manual-reflections/refreshing-reflections#incremental-refreshes-when-changes-to-an-anchor-table-include-non-append-operations)


  * Whether an incremental refresh can be performed depends [on the outcome of an algorithm](/acceleration/manual-reflections/refreshing-reflections#algorithm-for-determining-whether-an-incremental-or-a-full-refresh-is-used).
  * The initial refresh of a Reflection is always a [full refresh](/acceleration/manual-reflections/refreshing-reflections#full-refreshes).


##### Incremental Refreshes When Changes to an Anchor Table Are Only Append Operations[​](/acceleration/manual-reflections/refreshing-reflections#incremental-refreshes-when-changes-to-an-anchor-table-are-only-append-operations "Direct link to Incremental Refreshes When Changes to an Anchor Table Are Only Append Operations")
...
##### Incremental Refreshes When Changes to an Anchor Table Include Non-append Operations[​](/acceleration/manual-reflections/refreshing-reflections#incremental-refreshes-when-changes-to-an-anchor-table-include-non-append-operations "Direct link to Incremental Refreshes When Changes to an Anchor Table Include Non-append Operations")
...
For information about partitioning Reflections and applying partition transforms, see the section Horizontally Partition Reflections that Have Many Rows in [Best Practices for Creating Raw and Aggregation Reflections](/help-support/well-architected-framework/performance/#horizontally-partition-reflections-that-have-many-rows).
...
#### Full Refreshes[​](/acceleration/manual-reflections/refreshing-reflections#full-refreshes "Direct link to Full Refreshes")
In a full refresh, a Reflection is dropped, recreated, and loaded.
  * Whether a full refresh is performed depends [on the outcome of an algorithm](/acceleration/manual-reflections/refreshing-reflections#algorithm-for-determining-whether-an-incremental-or-a-full-refresh-is-used).
  * The initial refresh of a Reflection is always a full refresh.


#### Algorithm for Determining Whether an Incremental or a Full Refresh Is Used[​](/acceleration/manual-reflections/refreshing-reflections#algorithm-for-determining-whether-an-incremental-or-a-full-refresh-is-used "Direct link to Algorithm for Determining Whether an Incremental or a Full Refresh Is Used")
...
### Type of Refresh for Reflections on Delta Lake tables[​](/acceleration/manual-reflections/refreshing-reflections#type-of-refresh-for-reflections-on-delta-lake-tables "Direct link to Type of Refresh for Reflections on Delta Lake tables")
Only full refreshes are supported. In a full refresh, the Reflection being refreshed is dropped, recreated, and loaded.
### Types of Refresh for Reflections on All Other Tables[​](/acceleration/manual-reflections/refreshing-reflections#types-of-refresh-for-reflections-on-all-other-tables "Direct link to Types of Refresh for Reflections on All Other Tables")
  * **Incremental refreshes**
...
## Best Practice: Time Reflection Refreshes to Occur After Metadata Refreshes of Tables[​](/acceleration/manual-reflections/refreshing-reflections#best-practice-time-reflection-refreshes-to-occur-after-metadata-refreshes-of-tables "Direct link to Best Practice: Time Reflection Refreshes to Occur After Metadata Refreshes of Tables")
...
## Setting the Refresh Policy for Reflections[​](/acceleration/manual-reflections/refreshing-reflections#setting-the-refresh-policy-for-reflections "Direct link to Setting the Refresh Policy for Reflections")
...
### Types of Refresh Policies[​](/acceleration/manual-reflections/refreshing-reflections#types-of-refresh-policies "Direct link to Types of Refresh Policies")
...
### Procedures for Setting and Editing the Refresh Policy[​](/acceleration/manual-reflections/refreshing-reflections#procedures-for-setting-and-editing-the-refresh-policy "Direct link to Procedures for Setting and Editing the Refresh Policy")
...
## Manually Triggering a Refresh[​](/acceleration/manual-reflections/refreshing-reflections#manually-triggering-a-refresh "Direct link to Manually Triggering a Refresh")
...
## Viewing the Refresh History for Reflections[​](/acceleration/manual-reflections/refreshing-reflections#viewing-the-refresh-history-for-reflections "Direct link to Viewing the Refresh History for Reflections")
...
### Procedure[​](/acceleration/manual-reflections/refreshing-reflections#procedure "Direct link to Procedure")
...
### Result[​](/acceleration/manual-reflections/refreshing-reflections#result "Direct link to Result")
...
## Retry Policy for Reflection Refreshes[​](/acceleration/manual-reflections/refreshing-reflections#retry-policy-for-reflection-refreshes "Direct link to Retry Policy for Reflection Refreshes")
...
## Triggering Refreshes by Using the Reflection API, the Catalog API, or an SQL Command[​](/acceleration/manual-reflections/refreshing-reflections#triggering-refreshes-by-using-the-reflection-api-the-catalog-api-or-an-sql-command "Direct link to Triggering Refreshes by Using the Reflection API, the Catalog API, or an SQL Command")
You can refresh Reflections by using the Reflection API, the Catalog API, and the SQL commands `ALTER TABLE` and `ALTER VIEW`.
  * With the Reflection API, you specify the ID of a Reflection. See [Refresh a Reflection](/reference/api/reflections#refresh-a-reflection).
  * With the Catalog API, you specify the ID of a table or view that the Reflections are defined on. See [Refresh the Reflections on a Table](/reference/api/catalog/table#refresh-the-reflections-on-a-table) and [Refresh the Reflections on a View](/reference/api/catalog/view#refresh-the-reflections-on-a-view).
...
## Routing Refresh Jobs to Particular Queues[​](/acceleration/manual-reflections/refreshing-reflections#routing-refresh-jobs-to-particular-queues "Direct link to Routing Refresh Jobs to Particular Queues")
