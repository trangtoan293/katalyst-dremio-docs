...
## Working with files stored in S3[​](/data-sources/object/s3#working-with-files-stored-in-s3 "Direct link to Working with files stored in S3")
...
## Amazon Configuration[​](/data-sources/object/s3#amazon-configuration "Direct link to Amazon Configuration")
Amazon configuration involves:
  * Providing AWS credentials
  * Providing IAM Policy requirements


### Amazon S3 Credentials[​](/data-sources/object/s3#amazon-s3-credentials "Direct link to Amazon S3 Credentials")
...
### Sample IAM Policy for Accessing S3[​](/data-sources/object/s3#sample-iam-policy-for-accessing-s3 "Direct link to Sample IAM Policy for Accessing S3")
...
### Sample IAM Policy for Writing to S3[​](/data-sources/object/s3#sample-iam-policy-for-writing-to-s3 "Direct link to Sample IAM Policy for Writing to S3")
...
## Configuring Amazon S3 as a Source[​](/data-sources/object/s3#configuring-amazon-s3-as-a-source "Direct link to Configuring Amazon S3 as a Source")
...
### General[​](/data-sources/object/s3#general "Direct link to General")
...
#### Authentication[​](/data-sources/object/s3#authentication "Direct link to Authentication")
Choose one of the following authentication methods:
  * AWS Access Key: All or allowed (if specified) buckets associated with this access key or IAM role to assume, if provided, will be available. See [Advanced Options](/data-sources/object/s3#advanced-options) for whitelisted information.
  ...
  * EC2 Metadata: All or whitelisted (if specified) buckets associated with the IAM role attached to EC2 or IAM role to assume (if specified) will be available. See [Advanced Options](/data-sources/object/s3#advanced-options) for whitelisted information.
    * Under **IAM Role to Assume** , enter the 
...
#### AWS Custom Authentication[​](/data-sources/object/s3#aws-custom-authentication "Direct link to AWS Custom Authentication")
[AWS Glue](/data-sources/lakehouse-catalogs/aws-glue-catalog), [S3](/data-sources/object/s3), and [Amazon OpenSearch](/data-sources/databases/opensearch) sources allow Dremio to use your AWS profile to authenticate users accessing your AWS-hosted data.
...
#### Public Buckets[​](/data-sources/object/s3#public-buckets "Direct link to Public Buckets")
Add any external buckets that are not included with the provided AWS account credentials.
### Advanced Options[​](/data-sources/object/s3#advanced-options "Direct link to Advanced Options")
...
| **Enable partition column inference**  | Enable this option to change how Dremio handles partition columns (see [Partition Column Inference](/developer/data-formats/table#partition-column-inference) for more information.)  |  
...
#### Cache Options[​](/data-sources/object/s3#cache-options "Direct link to Cache Options")
...
#### Locations in which Iceberg Tables are Created[​](/data-sources/object/s3#locations-in-which-iceberg-tables-are-created "Direct link to Locations in which Iceberg Tables are Created")
...
#### Connecting through a proxy server[​](/data-sources/object/s3#connecting-through-a-proxy-server "Direct link to Connecting through a proxy server")
...
#### Connecting to a bucket in AWS GovCloud[​](/data-sources/object/s3#connecting-to-a-bucket-in-aws-govcloud "Direct link to Connecting to a bucket in AWS GovCloud")
...
#### Connecting to a bucket via AWS PrivateLink[​](/data-sources/object/s3#connecting-to-a-bucket-via-aws-privatelink "Direct link to Connecting to a bucket via AWS PrivateLink")
...
### Reflection Refresh[​](/data-sources/object/s3#reflection-refresh "Direct link to Reflection Refresh")
...
### Metadata[​](/data-sources/object/s3#metadata "Direct link to Metadata")
![](https://docs.dremio.com/assets/images/s3-metadata-eed8286e9d457256b62c1a95f6653cde.png) !
#### Dataset Handling[​](/data-sources/object/s3#dataset-handling "Direct link to Dataset Handling")
...
#### Metadata Refresh[​](/data-sources/object/s3#metadata-refresh "Direct link to Metadata Refresh")
  * **Dataset Discovery** -- Refresh interval for top-level source object names such as names of DBs and tables.
Dataset Discovery is available for [Google Cloud Storage (GCS)](/data-sources/object/gcs#metadata) and databases. For Amazon S3, Dremio lists folders and files in real time unless they have been converted to tables.
...
### Privileges[​](/data-sources/object/s3#privileges "Direct link to Privileges")
...
## Updating an Amazon S3 Source[​](/data-sources/object/s3#updating-an-amazon-s3-source "Direct link to Updating an Amazon S3 Source")
To update an Amazon S3 source:
  ...
  3. In the **Source Settings** dialog, edit the settings you wish to update. Dremio does not support updating the source name. For information about the settings options, see [Configuring Amazon S3 as a Source](/data-sources/object/s3#configuring-amazon-s3-as-a-source).
  4. Click **Save**.


## Deleting an Amazon S3 Source[​](/data-sources/object/s3#deleting-an-amazon-s3-source "Direct link to Deleting an Amazon S3 Source")
...
## Configuring S3-Compatible Storage[​](/data-sources/object/s3#configuring-s3-compatible-storage "Direct link to Configuring S3-Compatible Storage")
...
## Distributed Storage[​](/data-sources/object/s3#distributed-storage "Direct link to Distributed Storage")
...
## Configuring Minio as a Distributed Store[​](/data-sources/object/s3#configuring-minio-as-a-distributed-store "Direct link to Configuring Minio as a Distributed Store")
Minio can be be used as a distributed store. Note that Minio works as a distributed store for both SSL and unencrypted connections. See the configuration of S3-compatible distributed storage for [Dremio on Kubernetes](/deploy-dremio/configuring-kubernetes#configuring-the-distributed-storage) or [Dremio standalone clusters](/deploy-dremio/other-options/standalone/dremio-config/dremio-conf/dist-store-config#configuring-dremio-for-minio) for more information.
## Configuring Cloud Cache[​](/data-sources/object/s3#configuring-cloud-cache "Direct link to Configuring Cloud Cache")
See [Configuring Cloud Cache](/deploy-dremio/other-options/standalone/dremio-config/dremio-conf/cloud-cache-config) for more information.
## Configuring KMS Encryption for Distributed Store[​](/data-sources/object/s3#configuring-kms-encryption-for-distributed-store "Direct link to Configuring KMS Encryption for Distributed Store")
AWS Key Managment Service (KMS) is available for S3 distributed store. See the configuration of distributed storage for [Dremio on Kubernetes](/deploy-dremio/configuring-kubernetes#configuring-the-distributed-storage) or [Dremio standalone clusters](/deploy-dremio/other-options/standalone/dremio-config/dremio-conf/dist-store-config#amazon-s3) for more information.
## For More Information[​](/data-sources/object/s3#for-more-information "Direct link to For More Information")
...
[Previous Object Storage](/data-sources/object)[Next Azure Storage](/data-sources/object/azure-storage)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fdata-sources%2Fobject%2Fs3%2F&_biz_t=1777950321256&_biz_i=Amazon%20S3%20%7C%20Dremio%20Documentation&_biz_n=8&rnd=328808&cdn_o=a&_biz_z=1777950321256)
