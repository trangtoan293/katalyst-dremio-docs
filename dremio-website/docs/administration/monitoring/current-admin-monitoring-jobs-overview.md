...
## 1. Summary[​](/admin/monitoring/jobs/overview/#1-summary "Direct link to 1. Summary")
Each job is summarized by the following information:  
| Attribute  | Description  |  
| --- | --- |  
| Status  | Represents one or more job states. For descriptions, see [Job States and Statuses](/admin/monitoring/jobs/#job-states-and-statuses).  |  
...
| Query Type  | Represents one of the five query types: Accelerator, Downloads, External Tools, Internal, and UI. For descriptions, see Query Types in [Job Attributes](/admin/monitoring/jobs/#job-attributes).  |  
...
| Queue  | Defined by memory limits and CPU priority, or other specific characteristics to which queries can be assigned. For descriptions, see [Queues](/admin/workloads/workload-management/#queues).  |  
...
## 4. Download Query Support Bundle[​](/admin/monitoring/jobs/overview/#4-download-query-support-bundle "Direct link to 4. Download Query Support Bundle")
...
## 5. Submitted SQL[​](/admin/monitoring/jobs/overview/#5-submitted-sql "Direct link to 5. Submitted SQL")
The SQL query for the selected job.
## 6. Queried Datasets[​](/admin/monitoring/jobs/overview/#6-queried-datasets "Direct link to 6. Queried Datasets")
The datasets queried for the selected job. These can be views or tables.
## 7. Scans[​](/admin/monitoring/jobs/overview/#7-scans "Direct link to 7. Scans")
Scan details include the source type, scan thread count, IO wait time (in milliseconds), and the number of rows scanned.
## 8. Acceleration[​](/admin/monitoring/jobs/overview/#8-acceleration "Direct link to 8. Acceleration")
...
## 9. Results[​](/admin/monitoring/jobs/overview/#9-results "Direct link to 9. Results")
