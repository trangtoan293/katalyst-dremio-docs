...
## Job Classes[​](/admin/workloads/job-queues/#job-classes "Direct link to Job Classes")
...
## Query Queue Control[​](/admin/workloads/job-queues/#query-queue-control "Direct link to Query Queue Control")
...
## Reflection Queue Control[​](/admin/workloads/job-queues/#reflection-queue-control "Direct link to Reflection Queue Control")
...
## Query Memory Control[​](/admin/workloads/job-queues/#query-memory-control "Direct link to Query Memory Control")
Maximum memory per query can also be configured per job type under `Admin > Cluster > Queue Control > Query Memory Control`:
## Query Threshold[​](/admin/workloads/job-queues/#query-threshold "Direct link to Query Threshold")
...
[Previous Managing Job Workloads](/admin/workloads)[Next Job History & Job Details](/admin/workloads/jobs)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fadmin%2Fworkloads%2Fjob-queues%2F&_biz_t=1777950514680&_biz_i=Queue%20Control%20%7C%20Dremio%20Documentation&_biz_n=375&rnd=527180&cdn_o=a&_biz_z=1777950514680)
