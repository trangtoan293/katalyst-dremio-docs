...
As the [Dremio Shared Responsibility Models](/responsibility) outline, network connectivity is a shared responsibility between Dremio and you. The Shared Responsibility Models lay out Dremio's responsibilities for providing specifications and your responsibilities for provisioning and configuring resources.
## Hadoop Distributions[​](/deploy-dremio/other-options/standalone/system-requirements#hadoop-distributions "Direct link to Hadoop Distributions")
...
## Operating Systems[​](/deploy-dremio/other-options/standalone/system-requirements#operating-systems "Direct link to Operating Systems")
...
## Java Development Kit[​](/deploy-dremio/other-options/standalone/system-requirements#java-development-kit "Direct link to Java Development Kit")
...
## Browsers[​](/deploy-dremio/other-options/standalone/system-requirements#browsers "Direct link to Browsers")
...
## Server or Instance Hardware[​](/deploy-dremio/other-options/standalone/system-requirements#server-or-instance-hardware "Direct link to Server or Instance Hardware")
  * **Coordinators**
For [coordinators](/what-is-dremio/architecture#main-coordinator), Dremio recommends a machine with 32 CPUs and 64 GB of memory. The high CPU count is important for high-throughput workloads.
...
## Network[​](/deploy-dremio/other-options/standalone/system-requirements#network "Direct link to Network")
...
### Configuring the Conduit Port[​](/deploy-dremio/other-options/standalone/system-requirements#configuring-the-conduit-port "Direct link to Configuring the Conduit Port")
Dremio uses an ephemeral network port allocated by the operating system for inter-node communication between coordinators and executors. To assign a static port number to the conduit port, configure `services.conduit.port` in the [Dremio configuration file](/deploy-dremio/other-options/standalone/dremio-config).
...
### Web Sockets[​](/deploy-dremio/other-options/standalone/system-requirements#web-sockets "Direct link to Web Sockets")
...
### Performance[​](/deploy-dremio/other-options/standalone/system-requirements#performance "Direct link to Performance")
...
## Storage[​](/deploy-dremio/other-options/standalone/system-requirements#storage "Direct link to Storage")
### Metadata Storage[​](/deploy-dremio/other-options/standalone/system-requirements#metadata-storage "Direct link to Metadata Storage")
#### Base Requirements[​](/deploy-dremio/other-options/standalone/system-requirements#base-requirements "Direct link to Base Requirements")
...
#### High Availability[​](/deploy-dremio/other-options/standalone/system-requirements#high-availability "Direct link to High Availability")
...
### Distributed Store[​](/deploy-dremio/other-options/standalone/system-requirements#distributed-store "Direct link to Distributed Store")
...
| [Job results](/reference/admin-cli/metadata-cleanup#delete-jobs)  | Reuse query results  | Scales with number of jobs and length of retention; start with 150GB and monitor size  |  
### Additional Storage[​](/deploy-dremio/other-options/standalone/system-requirements#additional-storage "Direct link to Additional Storage")
