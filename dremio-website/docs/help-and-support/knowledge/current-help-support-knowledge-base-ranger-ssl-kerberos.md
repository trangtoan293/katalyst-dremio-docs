...
## Requirements[​](/help-support/knowledge-base/ranger-ssl-kerberos/#requirements "Direct link to Requirements")
...
## Creating self-signed keys for testing purposes[​](/help-support/knowledge-base/ranger-ssl-kerberos/#creating-self-signed-keys-for-testing-purposes "Direct link to Creating self-signed keys for testing purposes")
This section describes several methods used to create self-signed keys.
### Creating the credentials file from scratch using hadoop tool chain[​](/help-support/knowledge-base/ranger-ssl-kerberos/#creating-the-credentials-file-from-scratch-using-hadoop-tool-chain "Direct link to Creating the credentials file from scratch using hadoop tool chain")
...
### Creating the keystore using Java keytool[​](/help-support/knowledge-base/ranger-ssl-kerberos/#creating-the-keystore-using-java-keytool "Direct link to Creating the keystore using Java keytool")
...
### Creating the truststore using Java keytool[​](/help-support/knowledge-base/ranger-ssl-kerberos/#creating-the-truststore-using-java-keytool "Direct link to Creating the truststore using Java keytool")
...
The Hortonworks documentation mentions that when the keytool asks for your first and last name you should use the FQDN of the site (i.e example.com). All other fields should be left blank (you provided the password as an input to the keytool).
## Enabling SSL in Ranger-Admin[​](/help-support/knowledge-base/ranger-ssl-kerberos/#enabling-ssl-in-ranger-admin "Direct link to Enabling SSL in Ranger-Admin")
...
## Connecting to a Ranger host using SSL in Dremio[​](/help-support/knowledge-base/ranger-ssl-kerberos/#connecting-to-a-ranger-host-using-ssl-in-dremio "Direct link to Connecting to a Ranger host using SSL in Dremio")
See 
...
### Example policymgr-ssl.xml configuration (based on ranger-policymgr-ssl.xml):[​](/help-support/knowledge-base/ranger-ssl-kerberos/#example-policymgr-sslxml-configuration-based-on-ranger-policymgr-sslxml "Direct link to Example policymgr-ssl.xml configuration \(based on ranger-policymgr-ssl.xml\):")
...
### Configuring Dremio service principal for use in Kerberized Ranger[​](/help-support/knowledge-base/ranger-ssl-kerberos/#configuring-dremio-service-principal-for-use-in-kerberized-ranger "Direct link to Configuring Dremio service principal for use in Kerberized Ranger")
...
## Troubleshooting[​](/help-support/knowledge-base/ranger-ssl-kerberos/#troubleshooting "Direct link to Troubleshooting")
### Keystore or Password Error in a Kubernetes Deployment[​](/help-support/knowledge-base/ranger-ssl-kerberos/#keystore-or-password-error-in-a-kubernetes-deployment "Direct link to Keystore or Password Error in a Kubernetes Deployment")
