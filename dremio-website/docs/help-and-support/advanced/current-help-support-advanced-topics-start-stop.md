...
## Commands for all Deployments[​](/help-support/advanced-topics/start-stop/#commands-for-all-deployments "Direct link to Commands for all Deployments")
...
## YARN Deployments[​](/help-support/advanced-topics/start-stop/#yarn-deployments "Direct link to YARN Deployments")
...
### Starting up with YARN Deployments[​](/help-support/advanced-topics/start-stop/#starting-up-with-yarn-deployments "Direct link to Starting up with YARN Deployments")
...
### Shutting down with YARN Deployments[​](/help-support/advanced-topics/start-stop/#shutting-down-with-yarn-deployments "Direct link to Shutting down with YARN Deployments")
...
### Viewing Cluster Status with YARN Deployments[​](/help-support/advanced-topics/start-stop/#viewing-cluster-status-with-yarn-deployments "Direct link to Viewing Cluster Status with YARN Deployments")
To view the status of your Dremio cluster in the Dremio UI, navigate to the **Admin - &gt; Node Activity** screen.
## Non-YARN Deployments[​](/help-support/advanced-topics/start-stop/#non-yarn-deployments "Direct link to Non-YARN Deployments")
...
### Starting up with non-YARN Deployments[​](/help-support/advanced-topics/start-stop/#starting-up-with-non-yarn-deployments "Direct link to Starting up with non-YARN Deployments")
To start up a Dremio cluster:
...
### Shutting down with non-YARN Deployments[​](/help-support/advanced-topics/start-stop/#shutting-down-with-non-yarn-deployments "Direct link to Shutting down with non-YARN Deployments")
To shut down a Dremio cluster:
...
[Previous S3 on Amazon EMR Configuration](/help-support/advanced-topics/hive-s3)[Next Upgrading with Custom Sources](/help-support/advanced-topics/custom-arp)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd305d62a4c402de07902b3246ffbbc&_biz_l=https%3A%2F%2Fdocs.dremio.com%2Fcurrent%2Fhelp-support%2Fadvanced-topics%2Fstart-stop%2F&_biz_t=1777950543938&_biz_i=Start%2C%20Stop%2C%20and%20Status%20%7C%20Dremio%20Documentation&_biz_n=434&rnd=29208&cdn_o=a&_biz_z=1777950543938)
