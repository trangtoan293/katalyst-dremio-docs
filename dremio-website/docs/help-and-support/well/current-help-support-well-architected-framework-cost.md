...
## Principles[​](/help-support/well-architected-framework/cost/#principles "Direct link to Principles")
### Minimize Running Executor Nodes[​](/help-support/well-architected-framework/cost/#minimize-running-executor-nodes "Direct link to Minimize Running Executor Nodes")
...
### Eliminate Unnecessary Data Processing[​](/help-support/well-architected-framework/cost/#eliminate-unnecessary-data-processing "Direct link to Eliminate Unnecessary Data Processing")
...
## Best Practices[​](/help-support/well-architected-framework/cost/#best-practices "Direct link to Best Practices")
### Size Engines to Minimum Nodes Required[​](/help-support/well-architected-framework/cost/#size-engines-to-minimum-nodes-required "Direct link to Size Engines to Minimum Nodes Required")
...
### Remove Unused Reflections[​](/help-support/well-architected-framework/cost/#remove-unused-reflections "Direct link to Remove Unused Reflections")
...
### Optimize Metadata Refresh Frequency[​](/help-support/well-architected-framework/cost/#optimize-metadata-refresh-frequency "Direct link to Optimize Metadata Refresh Frequency")
