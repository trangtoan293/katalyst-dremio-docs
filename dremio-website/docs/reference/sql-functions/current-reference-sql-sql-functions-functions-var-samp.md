...
### VAR_SAMP(_col_name_ NUMERIC) → NUMERIC[​](/reference/sql/sql-functions#var_sampcol_name-numeric--numeric "Direct link to var_sampcol_name-numeric--numeric")
...
The VAR_SAMP function supports optional `PARTITION BY`, `ORDER_BY`, and sliding window frame subclauses. See [Window Functions](/reference/sql/sql-functions#window-functions) for more information and syntax.
