...
### GEO_BEYOND(_lat1_ float, _lon1_ float, _lat2_ float, _lon2_ float, _distance_ double) → boolean[​](/reference/sql/sql-functions#geo_beyondlat1-float-lon1-float-lat2-float-lon2-float-distance-double--boolean "Direct link to geo_beyondlat1-float-lon1-float-lat2-float-lon2-float-distance-double--boolean")
